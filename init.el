...
(custom-set-variables
 ...
 '(package-selected-packages
   '(magit magithub auto-sudoedit borland-blue-theme solarized-theme workgroups emojify helm-lsp which-key yasnippet projectile use-package flycheck lsp-ui lsp-java lsp-mode company smart-mode-line quickrun ace-window counsel ivy xah-fly-keys)))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :extend nil :stipple nil :background "black" :foreground "gold" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight bold :height 135 :width normal :family "Iosevka"))))
 '(dired-directory ((t (:foreground "red" :weight bold))))
 '(wg-mode-line-face ((t (:foreground "red")))))
