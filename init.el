...
(custom-set-faces
 ...
 '(wg-command-face ((t (:foreground "yellow"))))
 '(wg-filename-face ((t (:foreground "yellow"))))
 '(wg-message-face ((t (:foreground " blue"))))
 '(wg-mode-line-face ((t (:foreground "yellow"))))
 '(wg-previous-workgroup-face ((t (:foreground "yellow")))))
